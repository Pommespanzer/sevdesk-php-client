# ispserverfarm\sevdesk\php-client\AssetPosApi
...
# **addAssetPos**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAssetPos addAssetPos($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\AssetPosApi();
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAssetPos**](../Model/ModelAssetPos.md)
...
# **getAssetPositions**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAssetPos getAssetPositions($limit, $offset, $embed)
...
# **updateAssetPosition**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAssetPos updateAssetPosition($id, $body)
