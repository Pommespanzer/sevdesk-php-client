# ispserverfarm\sevdesk\OrderPosApi
...
# **addOrderPos**
> \ispserverfarm\sevdesk\sevDeskModel\ModelOrderPos addOrderPos($body)
...
$api_instance = new ispserverfarm\sevdesk\Api\OrderPosApi();
...
# **getOrderPositions**
> \ispserverfarm\sevdesk\sevDeskModel\ModelOrderPos getOrderPositions($limit, $offset, $embed)
...
# **updateOrderPos**
> \ispserverfarm\sevdesk\sevDeskModel\ModelOrderPos updateOrderPos($id, $body)
