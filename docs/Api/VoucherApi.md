# isp-serverfarm\sevdesk\php-client\VoucherApi
...
# **addVoucher**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher addVoucher($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\VoucherApi();
...
# **getVouchers**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher getVouchers($limit, $offset, $embed)
...
# **saveVoucher**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherFactory saveVoucher($body)
...
[**\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherFactory**](../Model/ModelVoucherFactory.md)
...
# **updateVoucher**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher updateVoucher($id, $body)
...
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelAccountingType voucherGetAccountingTypes($id, $embed)
...
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher voucherGetDependingRecurringVouchers($id, $embed)
...
# **voucherMarkAsOpen**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher voucherMarkAsOpen($id)
...
# **voucherMarkAsPaid**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher voucherMarkAsPaid($id, $body)
...
# **voucherRefundAmount**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherLog voucherRefundAmount($id, $body)
...
[**\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherLog**](../Model/ModelVoucherLog.md)
...
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherFactory voucherUploadTempFile($file)
