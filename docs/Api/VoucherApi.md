...
# **addVoucher**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher addVoucher($body)
...
# **getVouchers**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher getVouchers($limit, $offset, $embed)
...
# **saveVoucher**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucherFactory saveVoucher($body)
...
[**\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucherFactory**](../Model/ModelVoucherFactory.md)
...
# **updateVoucher**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher updateVoucher($id, $body)
...
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelAccountingType voucherGetAccountingTypes($id, $embed)
...
[**\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelAccountingType**](../Model/ModelAccountingType.md)
...
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher voucherGetDependingRecurringVouchers($id, $embed)
...
# **voucherMarkAsOpen**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher voucherMarkAsOpen($id)
...
# **voucherMarkAsPaid**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucher voucherMarkAsPaid($id, $body)
...
# **voucherRefundAmount**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucherLog voucherRefundAmount($id, $body)
...
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelVoucherFactory voucherUploadTempFile($file)
