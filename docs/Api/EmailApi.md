# isp-serverfarm\sevdesk\php-client\EmailApi
...
# **addEmail**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelEmail addEmail($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\EmailApi();
...
# **getEmails**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelEmail getEmails($limit, $offset, $embed)
...
# **updateEmail**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelEmail updateEmail($id, $body)
