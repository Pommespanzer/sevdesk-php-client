# ispserverfarm\sevdesk\CheckAccountApi
...
# **addCheckAccount**
> \ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccount addCheckAccount($body)
...
$api_instance = new ispserverfarm\sevdesk\Api\CheckAccountApi();
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccount**](../Model/ModelCheckAccount.md)
...
# **getCheckAccounts**
> \ispserverfarm\sevdesk\sevDeskModel\ModelDiscounts getCheckAccounts($limit, $offset, $embed)
...
# **updateCheckAccount**
> \ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccount updateCheckAccount($id, $body)
