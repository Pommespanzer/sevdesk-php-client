# ispserverfarm\sevdesk\php-client\DocumentApi
...
# **addDocument**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDocument addDocument($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\DocumentApi();
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDocument**](../Model/ModelDocument.md)
...
# **getDocuments**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDocument getDocuments($limit, $offset, $embed)
...
# **updateDocument**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDocument updateDocument($id, $body)
