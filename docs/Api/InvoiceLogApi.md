# ispserverfarm\sevdesk\InvoiceLogApi
...
# **addInvoiceLog**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceLog addInvoiceLog($body)
...
$api_instance = new ispserverfarm\sevdesk\Api\InvoiceLogApi();
...
# **getInvoiceLogs**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceLog getInvoiceLogs($limit, $offset, $embed)
...
# **updateInvoiceLog**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceLog updateInvoiceLog($id, $body)
