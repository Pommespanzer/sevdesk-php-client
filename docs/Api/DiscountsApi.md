# ispserverfarm\sevdesk\php-client\DiscountsApi
...
# **addDiscount**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDiscounts addDiscount($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\DiscountsApi();
...
# **getDiscounts**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDiscounts getDiscounts($limit, $offset, $embed)
...
# **updateDiscount**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelDiscounts updateDiscount($id, $body)
