# isp-serverfarm\sevdesk\php-client\VoucherLogApi
...
# **addVoucherLogEntry**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherLog addVoucherLogEntry($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\VoucherLogApi();
...
# **getVoucherLog**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherLog getVoucherLog($limit, $offset, $embed)
...
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherLog updateVoucherLogEntry($id, $body)
