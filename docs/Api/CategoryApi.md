# isp-serverfarm\sevdesk\php-client\CategoryApi
...
# **addCategory**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCategory addCategory($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\CategoryApi();
...
[**\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCategory**](../Model/ModelCategory.md)
...
# **getCategories**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCategory getCategories($limit, $offset)
...
# **updateCategory**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCategory updateCategory($id, $body)
