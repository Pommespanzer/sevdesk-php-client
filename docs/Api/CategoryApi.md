# ispserverfarm\sevdesk\php-client\CategoryApi
...
# **addCategory**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCategory addCategory($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\CategoryApi();
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCategory**](../Model/ModelCategory.md)
...
# **getCategories**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCategory getCategories($limit, $offset)
...
# **updateCategory**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCategory updateCategory($id, $body)
