# ispserverfarm\sevdesk\InvoiceApi
...
# **addInvoice**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice addInvoice($body)
...
$api_instance = new ispserverfarm\sevdesk\Api\InvoiceApi();
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelInvoice**](../Model/ModelInvoice.md)
...
# **cancelInvoice**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice cancelInvoice($id)
...
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice createInvoiceFromOrder($body)
...
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice createInvoiceReminder($body)
...
# **duplicateInvoice**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice duplicateInvoice($id)
...
# **getInvoices**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice getInvoices($limit, $offset, $embed)
...
# **invoiceAddPosition**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceAddPosition($id, $body)
...
# **invoiceBookAmount**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceLog invoiceBookAmount($id, $ammount, $date, $body)
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceLog**](../Model/ModelInvoiceLog.md)
...
# **invoiceChangeStatus**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceChangeStatus($id, $value)
...
> \ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccountTransactionLog invoiceGetCheckAccountTransactionLogs($id, $embed)
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccountTransactionLog**](../Model/ModelCheckAccountTransactionLog.md)
...
> \ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccountTransaction invoiceGetCheckAccountTransactions($id, $embed)
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelCheckAccountTransaction**](../Model/ModelCheckAccountTransaction.md)
...
# **invoiceGetDiscounts**
> \ispserverfarm\sevdesk\sevDeskModel\ModelDiscounts invoiceGetDiscounts($id, $embed)
...
# **invoiceGetDunnings**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceGetDunnings($id)
...
# **invoiceGetFeed**
> \ispserverfarm\sevdesk\sevDeskModel\ModelFeed invoiceGetFeed($id, $embed)
...
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceGetPartialInvoices($id, $embed)
...
# **invoiceGetPositions**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoicePos invoiceGetPositions($id, $limit, $offset, $embed)
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelInvoicePos**](../Model/ModelInvoicePos.md)
...
# **invoiceGetTags**
> \ispserverfarm\sevdesk\sevDeskModel\ModelTag invoiceGetTags($id, $embed)
...
# **invoiceMarkAsSent**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceMarkAsSent($id)
...
# **invoiceRefundAmount**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceRefundAmount($id, $ammount, $date)
...
# **invoiceSendBy**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice invoiceSendBy($id, $send_type)
...
# **saveInvoice**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceFactory saveInvoice($body)
...
[**\ispserverfarm\sevdesk\sevDeskModel\ModelInvoiceFactory**](../Model/ModelInvoiceFactory.md)
...
# **sendInvoiceViaEmail**
> \ispserverfarm\sevdesk\sevDeskModel\ModelEmail sendInvoiceViaEmail($id, $body)
...
# **sendInvoiceViaPost**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice sendInvoiceViaPost($id)
...
# **updateInvoice**
> \ispserverfarm\sevdesk\sevDeskModel\ModelInvoice updateInvoice($id, $body)
