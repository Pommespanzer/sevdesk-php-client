# isp-serverfarm\sevdesk\php-client\UnityApi
...
# **addUnity**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelOrderPos addUnity($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\UnityApi();
...
# **getUnities**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelUnity getUnities($limit, $offset, $embed)
...
[**\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelUnity**](../Model/ModelUnity.md)
...
# **updateUnity**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelUnity updateUnity($id, $body)
