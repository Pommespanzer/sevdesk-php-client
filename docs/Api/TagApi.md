# ispserverfarm\sevdesk\php-client\TagApi
...
# **addTag**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTag addTag($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\TagApi();
...
# **getTags**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTag getTags($limit, $offset, $embed)
...
# **updateTag**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTag updateTag($id, $body)
