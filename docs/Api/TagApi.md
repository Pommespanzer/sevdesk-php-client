# isp-serverfarm\sevdesk\php-client\TagApi
...
# **addTag**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTag addTag($body)
...
$api_instance = new isp-serverfarm\sevdesk\php-client\Api\TagApi();
...
# **getTags**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTag getTags($limit, $offset, $embed)
...
# **updateTag**
> \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTag updateTag($id, $body)
