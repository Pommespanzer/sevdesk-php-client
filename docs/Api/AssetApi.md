# ispserverfarm\sevdesk\php-client\AssetApi
...
# **addAsset**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAsset addAsset($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\AssetApi();
...
# **assetGetVoucher**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelVoucher assetGetVoucher($id, $embed)
...
# **getAssets**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAsset getAssets($limit, $offset, $embed)
...
# **updateAsset**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAsset updateAsset($id, $body)
