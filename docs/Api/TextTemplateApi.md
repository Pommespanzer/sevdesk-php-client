# ispserverfarm\sevdesk\php-client\TextTemplateApi
...
# **addTextTemplate**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate addTextTemplate($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\TextTemplateApi();
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate**](../Model/ModelTextTemplate.md)
...
# **getTextTemplate**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate getTextTemplate($limit, $offset, $embed)
...
# **updateTextTemplate**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate updateTextTemplate($id, $body)
