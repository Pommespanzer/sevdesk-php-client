# ispserverfarm\sevdesk\php-client\InvoicePosApi
...
# **addInvoicePos**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelInvoicePos addInvoicePos($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\InvoicePosApi();
...
# **getInvoicePositions**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelInvoicePos getInvoicePositions($limit, $offset, $embed)
...
# **updateInvoicePos**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelInvoicePos updateInvoicePos($id, $body)
