# ispserverfarm\sevdesk\php-client\VoucherPosApi
...
# **addVoucherPos**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherPos addVoucherPos($body)
...
$api_instance = new ispserverfarm\sevdesk\php-client\Api\VoucherPosApi();
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherPos**](../Model/ModelVoucherPos.md)
...
# **getVoucherPositions**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherPos getVoucherPositions($limit, $offset, $embed)
...
# **updateVoucherPos**
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelVoucherPos updateVoucherPos($id, $body)
...
> \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAsset voucherPosGetAssetInstance($id)
...
[**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelAsset**](../Model/ModelAsset.md)
