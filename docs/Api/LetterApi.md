# ispserverfarm\sevdesk\phpclient\LetterApi
...
# **addLetter**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelLetter addLetter($body)
...
$api_instance = new ispserverfarm\sevdesk\phpclient\Api\LetterApi();
...
[**\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelLetter**](../Model/ModelLetter.md)
...
# **getLetters**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelLetter getLetters($limit, $offset, $embed)
...
# **letterSendBy**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelLetter letterSendBy($id, $body)
...
# **updateLetter**
> \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelLetter updateLetter($id, $body)
