...
**_order** | [**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelOrder**](ModelOrder.md) | Model_Order the position belongs to | [optional] 
**_part** | [**\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPart**](ModelPart.md) | The Model_Part which is used in Model_OrderPos | [optional] 
