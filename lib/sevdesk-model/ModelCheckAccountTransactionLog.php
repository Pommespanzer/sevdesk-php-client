...
class ModelCheckAccountTransactionLog implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        '_create' => '\DateTime',
        '_check_account_transaction' => '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCheckAccountTransaction',
        '_from_status' => 'int',
        '_to_status' => 'int',
        '_amount_paid' => 'float',
     ...
     * @param \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCheckAccountTransaction $_check_account_transaction the check account transaction to which the log refers
     * @return $this
     */
