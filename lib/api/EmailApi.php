...
class EmailApi
{
    ...
    {
        list($response) = $this->addEmailWithHttpInfo($body);
        return $response;
    }
    ...
    public function addEmailWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addEmail');
        }
        // parse inputs
        $resourcePath = "/Email";
        $httpBody = '';
    ...
    {
        list($response) = $this->getEmailsWithHttpInfo($limit, $offset, $embed);
        return $response;
    }
