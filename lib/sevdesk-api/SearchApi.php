...
class SearchApi
{
     ...
     *
     * @param string $embed  (optional, default to contact,contact.parent,parent)
     * @param string $term Term you want to search (optional, default to )
     * @param string[] $search_type Specify a type (model) that you want to have searched (optional)
     * @throws \isp-serverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return void
     */
    public function search($embed = 'contact,contact.parent,parent', $term = '', $search_type = null)
    {
        list($response) = $this->searchWithHttpInfo($embed, $term, $search_type);
        return $response;
    }
     ...
     */
    public function searchWithHttpInfo($embed = 'contact,contact.parent,parent', $term = '', $search_type = null)
    {
        // parse inputs
        ...
        if (is_array($search_type)) {
            $search_type = $this->apiClient->getSerializer()->serializeCollection($search_type, 'multi', true);
        }
        if ($search_type !== null) {
            $queryParams['searchType'] = $this->apiClient->getSerializer()->toQueryValue($search_type);
        }
