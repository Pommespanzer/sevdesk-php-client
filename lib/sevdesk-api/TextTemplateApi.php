...
class TextTemplateApi
{
     ...
     * @return \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate
     */
    public function addTextTemplate($body)
    {
        list($response) = $this->addTextTemplateWithHttpInfo($body);
        return $response;
    }
     ...
     * @param string $body To create a text template, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     * @throws \isp-serverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return array of \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate, HTTP status code, HTTP response headers (array of strings)
     */
    public function addTextTemplateWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addTextTemplate');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate',
                '/TextTemplate'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelTextTemplate', $e->getResponseHeaders());
    ...
    {
        list($response) = $this->deleteTextTemplateWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteTextTemplateWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteTextTemplate');
        }
        // parse inputs
    ...
    {
        list($response) = $this->getTextTemplateWithHttpInfo($limit, $offset, $embed);
        return $response;
    }
    ...
    {
        list($response) = $this->updateTextTemplateWithHttpInfo($id, $body);
        return $response;
    }
    ...
    public function updateTextTemplateWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateTextTemplate');
        }
        // parse inputs
        $resourcePath = "/TextTemplate/{id}";
        $httpBody = '';
