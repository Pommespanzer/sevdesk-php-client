...
/**
 * CommunicationWayKeyApi Class Doc Comment
 *
 * @category Class
 * @package  ispserverfarm\sevdesk\php-client
 * @author   Swagger Codegen team
...
class CommunicationWayKeyApi
{
     ...
     * @param int $offset Set the index where the returned communication way keys start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCommunicationWayKey
     */
    public function getCommunicationWayKeys($limit = '100', $offset = '0')
    {
        list($response) = $this->getCommunicationWayKeysWithHttpInfo($limit, $offset);
        return $response;
    }
     ...
     * @param int $offset Set the index where the returned communication way keys start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCommunicationWayKey, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommunicationWayKeysWithHttpInfo($limit = '100', $offset = '0')
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCommunicationWayKey',
                '/CommunicationWayKey'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCommunicationWayKey', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelCommunicationWayKey', $e->getResponseHeaders());
