...
class ObjectUsedApi
{
     ...
     * @return \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelObjectUsed
     */
     ...
     * @param int $offset Set the index where the returned objects used start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelObjectUsed, HTTP status code, HTTP response headers (array of strings)
     */
    public function getObjectUsedWithHttpInfo($limit = '100', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelObjectUsed',
                '/ObjectUsed'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelObjectUsed', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelObjectUsed', $e->getResponseHeaders());
