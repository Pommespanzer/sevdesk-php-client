...
class FeedApi
{
    ...
    {
        list($response) = $this->addFeedWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation addFeedWithHttpInfo
     *
     * Create a new action which will be displayed in the feed
     *
     * @param string $body To create a new action for the feed, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
    ...
    public function addFeedWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addFeed');
        }
        // parse inputs
        $resourcePath = "/Feed";
        $httpBody = '';
    ...
    {
        list($response) = $this->deleteFeedWithHttpInfo($id);
        return $response;
    }
    ...
    public function deleteFeedWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteFeed');
        }
        // parse inputs
    ...
    {
        list($response) = $this->getFeedsWithHttpInfo($limit, $offset, $embed);
        return $response;
    }
    ...
    /**
     * Operation getParsedObjectAction
     *
    ...
    {
        list($response) = $this->getParsedObjectActionWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getParsedObjectActionWithHttpInfo
     *
     * Get more information about the specific feed object
     *
     * @param int $id Feed id of the object you want to get more information about (required)
    ...
    public function getParsedObjectActionWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getParsedObjectAction');
        }
        // parse inputs
        $resourcePath = "/Feed/{id}/getParsedObjectAction";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    {
        list($response) = $this->updateFeedWithHttpInfo($id, $body);
        return $response;
    }
    ...
    public function updateFeedWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateFeed');
        }
        // parse inputs
        $resourcePath = "/Feed/{id}";
        $httpBody = '';
