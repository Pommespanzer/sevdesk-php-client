...
class PlaceApi
{
     ...
     * @return \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPlace
     */
     ...
     * @param int $offset Set the index where the returned places start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPlace, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPlacesWithHttpInfo($limit = '1000', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPlace',
                '/Place'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPlace', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\php-client\sevdesk-model\ModelPlace', $e->getResponseHeaders());
