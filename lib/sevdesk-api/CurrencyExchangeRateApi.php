...
class CurrencyExchangeRateApi
{
     ...
     * @return \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCurrencyExchangeRate
     */
     ...
     * @param int $offset Set the index where the returned currency exchange rates start. Default is 0 (optional, default to 0)
     * @throws \isp-serverfarm\sevdesk\php-client\ApiException on non-2xx response
     * @return array of \isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCurrencyExchangeRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrencyExchangeRatesWithHttpInfo($limit = '1000', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCurrencyExchangeRate',
                '/CurrencyExchangeRate'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCurrencyExchangeRate', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\isp-serverfarm\sevdesk\php-client\sevdesk-model\ModelCurrencyExchangeRate', $e->getResponseHeaders());
