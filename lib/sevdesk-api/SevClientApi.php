...
class SevClientApi
{
    ...
    /**
     * Operation sevClientGetSevDeskAccountInvoices
     *
    ...
    {
        list($response) = $this->sevClientGetSevDeskAccountInvoicesWithHttpInfo();
        return $response;
    }

    /**
     * Operation sevClientGetSevDeskAccountInvoicesWithHttpInfo
     *
     * Get sevDesk account invoices
     *
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on non-2xx response
    ...
    {
        // parse inputs
        $resourcePath = "/SevClient/getSevDeskAccountInvoices";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
