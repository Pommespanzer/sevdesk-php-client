...
namespace ispserverfarm\sevdesk\php-client;
...
class ApiClient
{
     ...
     */
    public function __construct(\ispserverfarm\sevdesk\php-client\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \ispserverfarm\sevdesk\php-client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\ispserverfarm\sevdesk\php-client\ObjectSerializer::sanitizeForSerialization($postData));
        }
