...
class PlaceApi
{
     ...
     * @return \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelPlace
     */
     ...
     * @param int $offset Set the index where the returned places start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelPlace, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPlacesWithHttpInfo($limit = '1000', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelPlace',
                '/Place'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelPlace', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelPlace', $e->getResponseHeaders());
