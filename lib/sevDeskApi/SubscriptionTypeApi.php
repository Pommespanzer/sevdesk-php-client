...
class SubscriptionTypeApi
{
     ...
     * @return \ispserverfarm\sevdesk\sevDeskModel\ModelSubscriptionType
     */
     ...
     *
     * @throws \ispserverfarm\sevdesk\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\sevDeskModel\ModelSubscriptionType, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionTypesWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\sevDeskModel\ModelSubscriptionType',
                '/SubscriptionType'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\sevDeskModel\ModelSubscriptionType', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\sevDeskModel\ModelSubscriptionType', $e->getResponseHeaders());
