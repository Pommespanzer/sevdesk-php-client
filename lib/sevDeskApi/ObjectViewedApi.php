...
class ObjectViewedApi
{
     ...
     * @return \ispserverfarm\sevdesk\sevDeskModel\ModelObjectViewed
     */
     ...
     * @param string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;. (optional)
     * @throws \ispserverfarm\sevdesk\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\sevDeskModel\ModelObjectViewed, HTTP status code, HTTP response headers (array of strings)
     */
    public function getObjectViewedWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\sevDeskModel\ModelObjectViewed',
                '/ObjectViewed'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\sevDeskModel\ModelObjectViewed', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\sevDeskModel\ModelObjectViewed', $e->getResponseHeaders());
