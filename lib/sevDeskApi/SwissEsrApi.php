...
class SwissEsrApi
{
     ...
     * @return \ispserverfarm\sevdesk\sevDeskModel\ModelSwissEsr
     */
     ...
     *
     * @throws \ispserverfarm\sevdesk\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\sevDeskModel\ModelSwissEsr, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSwissEsrWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\sevDeskModel\ModelSwissEsr',
                '/SwissEsr'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\sevDeskModel\ModelSwissEsr', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\sevDeskModel\ModelSwissEsr', $e->getResponseHeaders());
