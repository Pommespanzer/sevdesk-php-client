...
class DocumentFolderApi
{
     ...
     * @return \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelDocumentFolder
     */
     ...
     * @param string $body To create a document folder, simply enter desired values after parameter&#x3D; and remove the quotation marks (required)
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelDocumentFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function addDocumentFolderWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelDocumentFolder',
                '/DocumentFolder'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelDocumentFolder', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\phpclient\sevDeskModel\ModelDocumentFolder', $e->getResponseHeaders());
