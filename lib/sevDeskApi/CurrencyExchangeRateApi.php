...
class CurrencyExchangeRateApi
{
     ...
     * @return \ispserverfarm\sevdesk\sevDeskModel\ModelCurrencyExchangeRate
     */
     ...
     * @param int $offset Set the index where the returned currency exchange rates start. Default is 0 (optional, default to 0)
     * @throws \ispserverfarm\sevdesk\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\sevDeskModel\ModelCurrencyExchangeRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrencyExchangeRatesWithHttpInfo($limit = '1000', $offset = '0')
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\sevDeskModel\ModelCurrencyExchangeRate',
                '/CurrencyExchangeRate'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\sevDeskModel\ModelCurrencyExchangeRate', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\sevDeskModel\ModelCurrencyExchangeRate', $e->getResponseHeaders());
