...
class DocumentApi
{
     ...
     * @param string $body To create a document, simply enter desired values after parameter&#x3D; and remove the quotation marks (required)
     * @throws \ispserverfarm\sevdesk\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\sevDeskModel\ModelDocument, HTTP status code, HTTP response headers (array of strings)
     */
    public function addDocumentWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\sevDeskModel\ModelDocument',
                '/Document'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\sevDeskModel\ModelDocument', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\sevDeskModel\ModelDocument', $e->getResponseHeaders());
