...
/**
 * StaticCountryApi Class Doc Comment
 *
 * @category Class
 * @package  ispserverfarm\sevdesk\phpclient
 * @author   Swagger Codegen team
...
class StaticCountryApi
{
    ...
    {
        list($response) = $this->getStaticCountryWithHttpInfo();
        return $response;
    }

    /**
     * Operation getStaticCountryWithHttpInfo
     *
     * Get staticCountry list
     *
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     ...
     */
    public function getStaticCountryWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/StaticCountry";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * @return void
     */
    public function getStaticIndustry()
    {
        list($response) = $this->getStaticIndustryWithHttpInfo();
        return $response;
    }

    /**
     * Operation getStaticIndustryWithHttpInfo
     *
     * Get staticIndustry list
     *
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStaticIndustryWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/StaticIndustry";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
