...
class StaticReferralProgramApi
{
     ...
     * @return \ispserverfarm\sevdesk\phpclient\Model\ModelStaticReferralProgram
     */
     ...
     *
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\phpclient\Model\ModelStaticReferralProgram, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStaticReferralProgramsWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\phpclient\Model\ModelStaticReferralProgram',
                '/StaticReferralProgram'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\phpclient\Model\ModelStaticReferralProgram', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\phpclient\Model\ModelStaticReferralProgram', $e->getResponseHeaders());
