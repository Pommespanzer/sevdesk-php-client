...
class EntryTypeApi
{
     ...
     * @param string $body To create an entry type, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     * @throws \ispserverfarm\sevdesk\phpclient\ApiException on non-2xx response
     * @return array of \ispserverfarm\sevdesk\phpclient\Model\ModelEntryType, HTTP status code, HTTP response headers (array of strings)
     */
    public function addEntryTypeWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ispserverfarm\sevdesk\phpclient\Model\ModelEntryType',
                '/EntryType'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\ispserverfarm\sevdesk\phpclient\Model\ModelEntryType', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ispserverfarm\sevdesk\phpclient\Model\ModelEntryType', $e->getResponseHeaders());
